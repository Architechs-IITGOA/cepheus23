			...
			<div className="events" id="Events">
				...
				<div className="events-bg">
					...
					<div id='landpage'  >
						...
						<Eventcard  data={listData[eveno]} userdata={this.props.userdata} success_createteam ={this.props.success_createteam} success_jointeam = {this.props.success_jointeam} success_regevent = {this.props.success_regevent} error = {this.props.error} setUserdata={this.props.setUserdata} islogin = {this.props.islogin} notlogin = {this.props.notlogin}exiting={()=>{
