...
export default function Profile({isProfileClicked,auth_reset,auth_continue,userdata, setEditProfile, setProfileClicked, setUserdata,success_logout,setislogin}) {
                ...
                <div className="profile-buttons">
                    ...
                    <div>
                        ...
                        render={renderProps => (
                            ...
                            clientId={clientId}
                            buttonText="Logout"
                            onLogoutSuccess={() => {console.log('loggedout successfully');success_logout();setislogin(false);auth_reset()}}
